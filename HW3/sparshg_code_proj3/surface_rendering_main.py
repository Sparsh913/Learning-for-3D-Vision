...
def render(
    ...
    imageio.mimsave('images/part_5.gif', [np.uint8(im * 255) for im in all_images], fps=10, loop=5000)
...
def train_points(
    ...
    imageio.mimsave('images/part_6_input.gif', [np.uint8(im * 255) for im in point_images], fps=10, loop=5000)
    ...
    for epoch in range(0, cfg.training.num_epochs):
        ...
        for idx in t_range:
            ...
            # loss = torch.linalg.norm(distances, dim=-1).mean()
        ...
        if (
            ...
            try:
                ...
                imageio.mimsave('images/part_6.gif', [np.uint8(im * 255) for im in test_images], fps=10, loop=5000)
...
def train_images(
    ...
    for epoch in range(start_epoch, cfg.training.num_epochs):
        ...
        if (
            ...
            imageio.mimsave('images/part_8.gif', [np.uint8(im * 255) for im in test_images], fps=10, loop=5000)
            ...
            try:
                ...
                imageio.mimsave('images/part_8_geometry.gif', [np.uint8(im * 255) for im in test_images], fps=10, loop=5000)
            except Exception as e:
                print("Empty mesh")
                pass
