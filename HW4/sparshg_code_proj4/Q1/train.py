...
def make_trainable(gaussians):
    ...
    # pass
    # trainable parameters in gaussians are:
    ...
    # gaussians.variances.requires_grad = True
...
def run_training(args):
    ...
    imageio.mimwrite(viz_gif_path_1, viz_frames, loop=5000, duration=(1/10.0)*1000)
    ...
    # Saving renderings
    imageio.mimwrite(viz_gif_path_2, frames, loop=5000, duration=(1/10.0)*1000)
